...
class Schemess_ClasswiseView(View):
    ...
    def get(self,request,**kwargs):
        ...
        return render(request,'students/child_detail/schemes_classwise_list.html',locals())
...
class Schemess(View):
    ...
    def get(self,request,**kwargs):
        try:
            ...
            return render(request,'students/child_detail/schemes_class_wise_count_table.html',{'child_detail_list':child_detail_list,'totalcount':totalcount,'I':I,'II':II,'III':III,'IV':IV,'V':V,'VI':VI,'VII':VII,'VIII':VIII,'IX':IX,'X':X,'XI':XI,'XII':XII,'school_code':school_code})
        except School_child_count.DoesNotExist:
            messages.add_message(
                self.request,
                messages.ERROR,"No School."
            )
            return render(request,'students/child_detail/schemes_class_wise_count_table.html')
    ...
    def post(self,request,**kwargs):
        if request.POST['search_id']!='':
            ...
            return render(request,'students/child_detail/schemes_term_classwise_list.html',{'child_search':child_search})
    ...
    def post(self,request,**kwargs):
        ...
        if form.is_valid():
            ...
            child = Child_detail(
                ...
                community_certificate_no = form.cleaned_data['community_certificate_no'],
                community_certificate_date = form.cleaned_data['community_certificate_date'],
                ...
                disadvantaged_group = dis_group_lst,
    ...
    def post(self,request,**kwargs):
        ...
        if form.is_valid():
            ...
            if form.cleaned_data["child_differently_abled"]  == "Yes":
                diff_abled_lst=''
                if request.POST.getlist("differently_abled_list1"):
                    differently_abled_list1 = request.POST.getlist("differently_abled_list1")
                    for group2 in differently_abled_list1:
                        diff_abled_lst = diff_abled_lst+group2
                if form.cleaned_data["differently_abled"]:
                    diff_abled_list=request.POST.getlist('differently_abled')
                    
                    for group1 in diff_abled_list:
                        diff_abled_lst=diff_abled_lst+group1+','
            else:
                diff_abled_lst = "N/A"
            ...
            child_edit.aadhaar_uid_number = form.cleaned_data['aadhaar_uid_number']
            child_edit.photograph = form.cleaned_data['photograph']
            child_edit.photo = form.cleaned_data['photograph']
            ...
            child_edit.community_certificate_no = form.cleaned_data['community_certificate_no']
            child_edit.community_certificate_date = form.cleaned_data['community_certificate_date']
            ...
            child_edit.differently_abled = form.cleaned_data['differently_abled']
            ...
            child_edit.weaker_section_income_certificate_no = form.cleaned_data['weaker_section_income_certificate_no']
            child_edit.child_disadvantaged_group = form.cleaned_data['child_disadvantaged_group']
            child_edit.disadvantaged_group = dis_group_lst
            ...
            child_edit.sport_participation = form.cleaned_data['sport_participation']
            child_edit.sports_player = form.cleaned_data['sports_player']
            child_edit.sports_name = form.cleaned_data['sports_name']
            ...
            child_edit.bus_from_route = form.cleaned_data['bus_from_route']
            child_edit.bus_to_route = form.cleaned_data['bus_to_route']
            child_edit.bus_route_no = form.cleaned_data['bus_route_no']
            child_edit.scholarship_from_other_source = form.cleaned_data['scholarship_from_other_source']
            child_edit.scholarship_details = form.cleaned_data['scholarship_details']
            child_edit.scholarship_other_details = form.cleaned_data['scholarship_other_details']
            child_edit.save()
            ...
            try:
                ...
                fmdetail_school = request.POST.getlist('sibling_studying_same_school')
                for entry in range(len(fmdetail_no)): 
                    newchild_fmdetail_edit = Child_family_detail.objects.get(child_key=pk)
...
class Child_detailDownloadProfileView(View):
    ...
    def get(self,request,**kwargs):
        ...
        #     child_detail_list = Child_detail.objects.filter(staff_id=school_code).exclude(transfer_flag = 1)    
        # else:
        child_detail_list = Child_detail.objects.values("name","aadhaar_eid_number","aadhaar_uid_number","gender","dob","community__community_name","religion__religion_name","mothertounge__language_name","phone_number","child_differently_abled","differently_abled","child_disadvantaged_group","disadvantaged_group","subcaste__caste_name","nationality__nationality","house_address","native_district","pin_code","blood_group","mother_name","mother_occupation","mother_income","father_name","father_occupation","father_income","class_studying__class_studying","group_code__group_name","attendance_status","sport_participation","education_medium__education_medium","district__district_name","block__block_name","unique_id_no","school_id","staff_id","bank__bank","bank_account_no","govt_schemes_status","schemes","academic_year__academic_year","transfer_flag","transfer_date","name_tamil","class_section","student_admitted_section","school_admission_no","bank_ifsc_code","sports_player","sports_name","community_certificate","child_status","height","weight","laptop_issued","laptop_slno","incentivebond_issued","bond_no","bond_date","guardian_name").filter(staff_id=schl_id.school_code,class_studying_id=pk).exclude(transfer_flag = 1)
        data = [['Name of the Student', 'Unique ID No', 'Class Studying', 'Section', 'Academic Year', 'Gender', 'Date of Birth', 'Community', 'Subcaste', 'Religion', 'Fathers Name', 'Mothers Name', 'Guardian Name', 'Address', 'Mother Tongue', 'Phone Number', 'Child Differently Abled', 'If yes', 'Child Disadvantaged Group', 'If yes', 'Aadhaar Eid Number', 'Aadhaar Uid Number'
                , 'Nationality', 'Native District', 'Pincode', 'Blood Group', 'Mothers Occupation', 'Mothers Income', 'Fathers Occupation', 'Fathers Income', 'Attendance Status', 'Sport Participation', 'Education Medium', 'Bank Account No', 'Bank Ifsc Code', 'Govt Schemes Status', 'If Yes', 'Student Admitted Section', 'School Admission No', 'Sports Player', 'Sports Name', 'Community Certificate'
                , 'Child Status', 'Height (cm)', 'Weight (kg)', 'Laptop Issued', 'Laptop Slno', 'Incentivebond Issued', 'Bond No', 'Bond Date']]
        for i in child_detail_list:
            data.append([i['name'], i['unique_id_no'], i['class_studying__class_studying'], i['class_section'], i['academic_year__academic_year'], i['gender'], i['dob'], i['community__community_name'], i['subcaste__caste_name'], i['religion__religion_name'], i['father_name'], i['mother_name'], i['guardian_name'], i['house_address'], i['mothertounge__language_name'], i['phone_number'], i['child_differently_abled'], i['differently_abled'], i['child_disadvantaged_group'], i['disadvantaged_group'], i['aadhaar_eid_number'], i['aadhaar_uid_number']
                , i['nationality__nationality'], i['native_district'], i['pin_code'], i['blood_group'], i['mother_occupation'], i['mother_income'], i['father_occupation'], i['father_income'], i['attendance_status'], i['sport_participation'], i['education_medium__education_medium'], i['bank_account_no'], i['bank_ifsc_code'], i['govt_schemes_status'], i['schemes']
                , i['student_admitted_section'], i['school_admission_no'], i['sports_player'], i['sports_name'], i['community_certificate'], i['child_status'], i['height'], i['weight'], i['laptop_issued'], i['laptop_slno'], i['incentivebond_issued'], i['bond_no'], i['bond_date']])
